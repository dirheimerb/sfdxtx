...
export default class DQValidation extends LightningElement {
            ...
            getDQMetadata()
                .then((result) => {
                    ...
                    DQMetetadataRecords.forEach((t) => {
                        if (t.DeveloperName == 'Email_Validation') {
                            ...
                            if (
                                ...
                                if (this.isEmptyOrNull(email)) {
                                    this.contactData.Email_Verification_Status__c =
                                        null;
                                    this.contactData.Email_Verification_Date__c =
                                        null;
                                }
                            }
                            ...
                            if (
                                t.DQ_Service_On__c &&
                                this.dqFieldToValidates.includes(
                                    'SecondaryEmail'
                                )
                            ) {
                                this.DQValidationEmail(
                                    secondaryEmail,
                                    'isSecondaryEmail'
                                );
                            } else {
                                ...
                                if (this.isEmptyOrNull(secondaryEmail)) {
                                    this.contactData.Secondary_Email_Verification_Status__c =
                                        null;
                                    this.contactData.Secondary_Email_Verification_Date__c =
                                        null;
                                }
                            }
                            ...
                            if (
                                ...
                                if (this.isEmptyOrNull(phone)) {
                                    this.contactData.Phone_Verification_Status__c =
                                        null;
                                    this.contactData.Phone_Verification_Date__c =
                                        null;
                                }
                            }
                            ...
                            if (
                                ...
                                if (this.isEmptyOrNull(mobilePhone)) {
                                    this.contactData.Mobile_Phone_Verification_Status__c =
                                        null;
                                    this.contactData.Mobile_Phone_Verification_Date__c =
                                        null;
                                }
                            }
				...
				this.DQValidationAddress();
                                    ...
                                    if (this.isEmptyOrNull(newAddress)) {
                                        this.contactData.Address_Verification_Status__c =
                                            null;
                                        this.contactData.Address_Verification_Date__c =
                                            null;
                                    }
                                }
                            } else {
            ...
            var checkAllResponse = window.setInterval(() => {
                if (
                    ...
                    if (
                        ...
                        this.showSuccessMsgMobilePhone ==
                            this.LABEL.invalidMobile ||
                        ...
                        if (this.invalidDataLists.length > 0) {
                            this.showModal_Invalid =
                                this.showModal_Invalid || true;
    ...
    DQValidationAddress() {
        ...
        if (this.isNotBlank(this.contactDetailData.MailingStreet)) {
            ...
            addressLine2 =
                mailingStreet[1] == undefined ? '' : mailingStreet[1];
            addressLine3 =
                mailingStreet[2] == undefined ? '' : mailingStreet[2];
            addressLine4 =
                mailingStreet[3] == undefined ? '' : mailingStreet[3];
    ...
    DQVerifyPrimaryEmail(emailResponss) {
        ...
        if (
            ...
            emailResponss.statusDescription ==
                this.LABEL.Verified_Questionable ||
            ...
            emailResponss.statusDescription == this.LABEL.Verified_Invalid
        ) {
            this.contactData.Email_Verification_Status__c =
                emailResponss.statusDescription;
            this.contactData.Email_Verification_Date__c = today;
