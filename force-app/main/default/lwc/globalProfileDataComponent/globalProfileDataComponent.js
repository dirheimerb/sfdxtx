...
export default class GlobalProfileDataComponent extends NavigationMixin(
    ...
    navigateContactCreation(event) { 
        if(this.globalprofileindex !== undefined){       //SFSC - 7070 - added null check
    ...
    mapSelectedGlobalRecordToContactData() {
        ...
        globalprofileindex =
            parseInt(this.pageSize * (this.page - 1)) +
            parseInt(globalprofileindex); // // 11

        var phoneNumbersData =
            this.globalProfiles[globalprofileindex].phoneNumbers;
