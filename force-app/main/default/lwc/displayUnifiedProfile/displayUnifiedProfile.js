...
wiredRecord({ error, data }) {
  if (error) {
        ...
        this.contactData.fields.MailingStreet.length > 0 ? (this.contactMailingStreet = this.contactData.fields.MailingStreet.value) : (this.contactMailingStreet = "");
         this.contactData.fields.MailingStateCode.length > 0 ? (this.contactMailingStateCode = this.contactData.fields.MailingStateCode.value) : (this.contactMailingStateCode = "");
         this.contactData.fields.MailingPostalCode.length > 0 ? (this.contactMailingPostalCode = this.contactData.fields.MailingPostalCode.value) : (this.contactMailingPostalCode = "");
         this.contactData.fields.MailingCountry.length > 0 ? (this.contactMailingCountryCode = this.contactData.fields.MailingCountry.value) : (this.contactMailingCountryCode = "");
         this.contactData.fields.MailingCity.length > 0 ? (this.contactMailingCity = this.contactData.fields.MailingCity.value) : (this.contactMailingCity = "");
         console.log('this.contactMailingCity', this.contactMailingCity);
         console.log('this.contactMailingCountryCode', this.contactMailingCountryCode);
         console.log('contactEmail is', this.contactEmail);
         console.log('contactPhone is', this.contactPhone);
         console.log('contactSecondary_Email__c is', this.contactSecondary_Email__c);
         console.log('contactMobilePhone is', this.contactMobilePhone);
         console.log('contactMailingCity is', this.contactMailingCity);
         console.log('contactMailingCountryCode is', this.contactMailingCountryCode);
         ...
         console.log('this.contactData.fields.MailingCountry.value.length', this.contactData.fields.MailingCountry.value.length);
         console.log('this.contactData.fields.MailingStateCode.length', this.contactData.fields.MailingStateCode.value.length);
